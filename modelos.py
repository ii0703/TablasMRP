from sqlalchemy import (String, Numeric, Boolean, Integer, DateTime, Date, ForeignKey, Double, Text)
from sqlalchemy.orm import relationship, Mapped, mapped_column
from sqlalchemy import func, UniqueConstraint, CheckConstraint, Index
...
class CategoriaMateriaPrima(Model):
...
class MateriaPrimaProveedor(Model):
...
class ListaMaterialesComponentes(Model):
...
class ListaMaterialesMateriasPrimas(Model):
